...
contract StoreFront2 is ERC721("NefariousCrypto","888"),ERC721Enumerable{
    ...
    constructor(){
        signerAddress = 0x3F41cEC1E08FcBD5357E6bb873cfa4185683Cf31;
		ownAddress=0xc92c1300aF2e4b65062e6f7e7B94c0fbe75C0fC4;
    ...
    function buy( uint[] memory _tokens, uint _price, bytes memory _signature) public payable{
		...
		/* if (_remain > 0) {
			bool sent;                                                             
			bytes memory data;
			(sent, data) = payable(ownAddress).call{value: msg.value}("");
